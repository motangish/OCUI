do
  _G._OSVERSION = "OpenOS 1.6 with UI"
  ...
  if gpu and screen then
    ...
    component.invoke(gpu, "setBackground", 0x006D80)
  ...
  local function status(msg)
    if gpu and screen then
      component.invoke(gpu, "setBackground", 0x006D80)
      component.invoke(gpu, "fill", 1, h / 3 * 2, w, 1, " ")
      component.invoke(gpu, "set", w / 2 - string.len(msg) / 2, h / 3 * 2, msg)
      if y == h then
